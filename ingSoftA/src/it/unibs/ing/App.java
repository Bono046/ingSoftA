...
// metodo di inizializzazione e di controllo in caso di file json esistente ma vuoto
 ...
 // si rompe se non si digita un numero
 private void mostraMenuPrincipale() {
     while (true) {
         System.out.println("Menu Principale:");
         System.out.println("1. Registrazione Configuratore");
